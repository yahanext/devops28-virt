...
- высоконагруженная база данных, чувствительная к отказу; кластер vmware esxi с выскопроизводительным схд
- различные web-приложения; виртуализация уровня ос
- Windows-системы для использования бухгалтерским отделом; кластер vmware esxi
